...
class CprPredictor(ABC):
    ...
    def preprocess(self, data:pd.DataFrame):
        try:
            ...
            # data['industry_volume'] = data['industry_volume'].astype('int64')
            # data['soda_volume'] = data['soda_volume'].astype('int64')
            # data['avg_population_2017'] = data['avg_population_2017'].astype('int64')
            # data['avg_yearly_household_income_2017'] = data['avg_yearly_household_income_2017'].astype('int64')
            ...
            batch_dataset = TimeSeriesDataSet(data,
                                                time_idx= "time_idx",
                                                target="volume",
